function [fn, pn] = uisave_ch(variables, filename, tit)
...
%
%   UISAVE(VARIABLES, FILENAME, TIT) uses the specified file name as the default
%   instead of "matlab.mat", and uses the given title TIT.
%
...
%
%   This has been edited by csh to allow for customized titles (tit) and to
%   output the file and path names.  I'm using it in SEML and the t_chain
%   functions.  
...
[fn,pn,filterindex] = uiputfile(filters, tit, seed);
